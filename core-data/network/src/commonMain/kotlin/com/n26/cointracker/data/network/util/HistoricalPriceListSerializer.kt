...
object HistoricalPriceListSerializer : KSerializer<List<HistoricalPriceDto>> {
    ...
    override fun serialize(encoder: Encoder, value: List<HistoricalPriceDto>) {
        ...
        val jsonArray = JsonArray(value.map { dataPoint ->
            JsonArray(listOf(JsonPrimitive(dataPoint.utcTimestamp), JsonPrimitive(dataPoint.price)))
        })
        jsonEncoder.encodeJsonElement(jsonArray)
    }

    override fun deserialize(decoder: Decoder): List<HistoricalPriceDto> {
